...
1) Создать dll - сборку, в которой нужно реализовать интерфейс [IReportGenerator](91136537.htm) или [ICustomizableReportGenerator](5AB62F09.htm).
...
Пример реализации интерфейса ICustomizableReportGenerator для пользовательского генератора отчётовC#[Копировать](# "Копировать")
...
[TFlex.ReportingIReportGenerator](91136537.htm)
[TFlex.ReportingICustomizableReportGenerator](5AB62F09.htm)

[TFlex.ReportingIAuthorInfo](FF9A1C6F.htm)

[TFlex.DOCs.Model.References.ReportingReportGenerationContext](FDD27C59.htm)

[TFlex.DOCs.Model.ReferencesReference](26AE86E6.htm)

Пример кода редактора шаблонов для пользовательского генератора отчётовC#[Копировать](# "Копировать")
...
Пример шаблона для отчёта, который будет заполняться пользовательским генератором отчётовC#[Копировать](# "Копировать")
