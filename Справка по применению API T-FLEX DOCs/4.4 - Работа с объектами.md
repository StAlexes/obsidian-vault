...
Получение объектов по обратным связямОбратные связи![Swapped Links](_assets/SwappedLinks.png)C#
...
```csharp
Получение подключений по связямC#
...
| Внимание |
| --- |
| Обратите внимание, что данный метод действителен только для удаления неверсионных объектов.  Удаление версионных объектов описано в разделе 'Работа с версионными объектами' |
...
| Внимание |
| --- |
| Обратите внимание, что данный метод действителен только для разблокировки неверсионных объектов.  Для разблокировки версионных объектов необходимо произвести отмену изменений при помощи метода `ReferenceObject.UndoCheckOut()` , пример доступен в разделе 'Работа с версионными объектами' |
