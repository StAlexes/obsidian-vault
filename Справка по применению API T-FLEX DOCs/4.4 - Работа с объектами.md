...
Получение объектов по обратным связямОбратные связи![Swapped Links](_assets/SwappedLinks.png)C#[Копировать](# "Копировать")
...
Получение подключений по связямC#[Копировать](# "Копировать")
