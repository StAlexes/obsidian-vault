...
![Изображение](../icons/SectionExpanded.png)Пример генерации отчета с заданными параметрами
...
![Generate Report 1](../media/GenerateReport1.png)

Сгенерированный отчет:

![Generate Report 2](../media/GenerateReport2.png)
...
[TFlex.DOCs.Model.Macros.ObjectModelДиалогВвода](DE5512D5.htm)
...
[TFlex.DOCs.Model.References.ReportingReferenceObjectWithLink](7EF197D.htm)

[TFlex.DOCs.Model.References.ReportingReportGenerationContext](FDD27C59.htm)

[TFlex.DOCs.Model.References.ReportingReport](EC2BDBE3.htm)
