...
![Изображение](../icons/SectionExpanded.png)Пример создания и подключения объекта к родителю в справочнике со сложной иерархией.
...
[CreateChildLink](B535F805.htm)
класса
[ReferenceObject](85856F0C.htm)
...
![Create Child Link Example](../media/CreateChildLinkExample.png)

![Изображение](../icons/SectionExpanded.png)Пример создания и подключения объекта к родителю в ЭСИ при использовании механизма связанных справочников
...
[TFlex.DOCs.Model.References.DocumentsEngineeringDocumentObject](9227668F.htm)
