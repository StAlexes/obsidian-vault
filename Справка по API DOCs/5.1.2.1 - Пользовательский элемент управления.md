...
![Изображение](../icons/SectionExpanded.png)Пример элемента управления пользователя
...
![Изображение](../icons/SectionExpanded.png)Пример кода ViewsModels
...
![Изображение](../icons/SectionExpanded.png)Пользовательский элемент управления (WPF)
...
![Изображение](../icons/SectionExpanded.png)Пример добавления пользовательского элемента управления в диалог свойств справочника
...
2. Перейти в "Управление справочниками", выбрать тип нужного нам справочника
   ...
   ![User Control Wpf Customization Reference 1](../media/UserControlWpfCustomizationReference1.PNG)
3. Открыть настройку редактирования пользовательской страницы на вкладке "Диалог свойств"

   ![User Control Wpf Customization Reference 2](../media/UserControlWpfCustomizationReference2.PNG)
4. Перенести на пользовательскую страницу и добавить "Пользовательский элемент управления"

   ![User Control Wpf Customization Reference 3](../media/UserControlWpfCustomizationReference3.PNG)
5. Указать настройки - "DLL файл из справочника", "Наименование класса" и "Наименование класса ViewModel"

   ![User Control Wpf Customization Reference 4](../media/UserControlWpfCustomizationReference4.PNG)
6. Открыть диалог свойств, где расположен пользовательский элемент управления

   ![User Control Wpf Customization Reference 5](../media/UserControlWpfCustomizationReference5.PNG)
