...
![Изображение](../icons/SectionExpanded.png)Пример реализации интерфейса ICustomizableReportGenerator для пользовательского генератора отчётов
...
![Изображение](../icons/SectionExpanded.png)Пример кода редактора шаблонов для пользовательского генератора отчётов
...
![Custom Report Generator Editor](../media/CustomReportGeneratorEditor.PNG)

![Изображение](../icons/SectionExpanded.png)Пример шаблона для отчёта, который будет заполняться пользовательским генератором отчётов
